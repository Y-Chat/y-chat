...
import {Avatar, Button, Group, rem, Stack, TagsInput, TextInput} from "@mantine/core";
    ...
    return (
        <form onSubmit={form.onSubmit(async () => {
            ...
            <Stack>
                ...
                />
                <Button type="submit" loading={formLoading} leftSection={<IconPlus/>} mt="md">Create</Button>
            </Stack>
        </form>
    );
}